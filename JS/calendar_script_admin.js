...
calendarDates.addEventListener('click', async (event) => {
    ...
    if (events.length > 0) {
        ...
        datesContent.innerHTML = `
            ...
            <button id="book-event-btn" class="book-event-btn" style="margin-bottom: 10px; padding: 8px; background-color: green; color: white; border: none; border-radius: 5px; cursor: pointer;">Add Event</button>
            </div>
